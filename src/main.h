...
static const unsigned int MAX_BLOCK_SIZE = 11000000;
...
static const int64 MAX_MONEY = 20000000000 * COIN; // ~20 Billion Total [HardCap]
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 70; // +20 = 90 Total
