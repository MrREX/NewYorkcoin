...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click newyorkcoin: links)
...
{
    // clicking on newyorkcoin: URLs creates FileOpen events on the Mac:
