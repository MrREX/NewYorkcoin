    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-2013 ") + QString(tr("The Bitcoin developers")); // (%1) .arg(COPYRIGHT_YEAR) + Qtsrt...
    QString copyrightText2  = QChar(0xA9)+QString(" 2013-2014") + QString(tr("The NewYorkcoin developers"));
    QString copyrightText3  = QChar(0xA9)+QString(" 2015 ") + QString(tr("The NewYorkcoin developers"));
