...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\NewYorkcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\NewYorkcoin
    // Mac: ~/Library/Application Support/NewYorkcoin
    // Unix: ~/.newyorkcoin
#ifdef WIN32
    // Windows
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDefaultDataDir() / "newyorkcoin.conf";
    ...
    {
        // Don't overwrite existing settings so command line settings override newyorkcoin.conf
